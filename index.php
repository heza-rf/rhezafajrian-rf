        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $data['nama_toko']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  <?php echo $data['level']; ?> - <?php echo $data['nama']; ?>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
  ...
  <aside class="main-sidebar sidebar-fixed">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="?page=user">
            <i class="fa fa-user text-aqua"></i> <span>User</span>
        ...
        <li>
          <a href="?page=pelanggan">
            <i class="fa fa-users text-aqua"></i> <span>pelanggan</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
<?php } ?>
        <li>
          <a href="index.php">
            <i class="fa fa-home text-aqua"></i> <span>Dashboard</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
        ...
        <li>
          <a href="?page=barang">
            <i class="fa fa-list text-aqua"></i> <span>Manajemen Barang</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
        ...
        <li>
          <a href="?page=transaksi&kodepj=<?php echo $kode; ?> ">
            <i class="fa fa-money text-aqua"></i> <span>transaksi</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
        ...
        <li>
          <a data-toggle="modal" data-target="#modal-default">
            <i class="fa fa-bar-chart text-aqua"></i> <span>laporan</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
    ...
    <section class="content-header">
      <?php 
          ...
          if ($page == "transaksi") {
            ...
            if ($aksi == "pembayaran") {
              include "page/transaksi/pembayaran.php";
            ...
            if ($aksi == "tambah") {
             ...
             if ($aksi == "kurang") {
              include "page/transaksi/kurang.php";
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="POST" action="page/laporan/cetak.php?id_us=<?php echo $user; ?>" target="Blank">
